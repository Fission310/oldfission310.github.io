...
import { FaHome, FaNewspaper, FaGamepad } from "react-icons/fa/";
...
class Menu extends React.Component {
  constructor(props) {
    ...
    this.items = [
      ...
      { to: "/category/", label: "Blog", icon: FaNewspaper },
      ...pages,
      // { to: "https://theorangealliance.org/teams/310", label: "Competition", icon: FaGamepad },
